package com.adotcode.scaffold.core.interceptor;
...
public class VersionInterceptor implements Interceptor {
  ...
  public Object intercept(Invocation invocation) throws Throwable {
    ...
    // 获取版本号
    Object originalVersion = metaObject
        .getValue("delegate.boundSql.parameterObject." + VERSION_COLUMN_NAME);
  ...
  private String addVersionToSql(String originalSql, Object originalVersion) {
    try {
      ...
      log.error("add version to sql error", e);
      return originalSql;
    }
  }
